      ...
      <div className="relative w-full max-w-fit m-auto min-h-[100dvh] flex flex-col justify-start items-center py-4 gap-4">
        <div className="w-full flex flex-col gap-2">
          ...
          <div
            ...
            } bg-white min-h-fit p-3 rounded-md shadow-lg transition-all`}
          >
            <p
        ...
        <div className="w-fit h-full grid place-items-center rounded-lg">
          <Document file={PdfFile} onLoadSuccess={onDocumentLoadSuccess}>
            <div
              ...
              ref={docsRef}
            >
              <div className="w-full absolute top-0 bg-black bg-opacity-30 flex justify-between px-4 py-2 z-100">
                <button
